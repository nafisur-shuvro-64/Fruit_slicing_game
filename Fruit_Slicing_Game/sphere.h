...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 0.1f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3 diff = glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(24)
    {
