...
-0.0400, 0.4000, 5.1000,
    ...
    string diffuseMapPath2 = "game_over2.jpg";
    string specularMapPath2 = "game_over2.jpg";
    ...
    string diffuseMapPathWall = "wmln.jpg";
    string specularMapPathWall = "wmln.jpg";
    ...
    string diffuseMapPathWall2 = "wall2.jpg";
    string specularMapPathWall2 = "wall2.jpg";
    unsigned int diffMapWall2 = loadTexture(diffuseMapPathWall2.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
    unsigned int specMapWall2 = loadTexture(specularMapPathWall2.c_str(), GL_REPEAT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR);
    Cube wallcube2 = Cube(diffMapWall2, specMapWall2, 32.0f, 0.0f, 0.0f, 1.0f, 1.0f);
    ...
    //orange
    string diffuseMapPath4 = "orange.jpg";
    string specularMapPath4 = "orange.jpg";
    ...
    Sphere2 orangeOut = Sphere2(0.1f, 144, 72, glm::vec3(0.898f, 0.459f, 0.125f), glm::vec3(0.898f, 0.459f, 0.125f), glm::vec3(0.5f, 0.5f, 0.5f), 32.0f, diffMap3, specMap3, 0.0f, 0.0f, 1.0f, 1.0f);

    diffuseMapPath4 = "orange_in.png";
    specularMapPath4 = "orange_in.png";
    ...
    Sphere2 orangeIn = Sphere2(0.09f, 144, 72, glm::vec3(0.898f, 0.459f, 0.125f), glm::vec3(0.898f, 0.459f, 0.125f), glm::vec3(0.5f, 0.5f, 0.5f), 32.0f, diffMap3, specMap3, 0.0f, 0.0f, 1.0f, 1.0f);


  

    string diffuseMaptub = "orangev.png";
    ...
    camera.Position = glm::vec3(0.0f, 1.8f, -7.9f);
    while (!glfwWindowShouldClose(window))
    {
        ...
        //glm::mat4 identityMatrix = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
        //glm::mat4 translateMatrix, rotateXMatrix, rotateYMatrix, rotateZMatrix, scaleMatrix, model;
        translateMatrix = glm::translate(identityMatrix, glm::vec3(-1.5, 0.3, -2.5));
        ...
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(.25, .4, .25));
        ...
        rotateZMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(.25, .4, .25));
        model21 = translateMatrix * rotateXMatrix * rotateYMatrix * rotateZMatrix * scaleMatrix;
        lightingShaderWithTexture.setMat4("model", model21);
        curve.draw(lightingShaderWithTexture, model21, glm::vec3(1.0f, 0.0f, 0.0f));
            ...
            if (randomValue + 0.1f >= gun_x && randomValue - 0.1f <= gun_x)
            {
                ...
                if (gun_y + 0.5f >= yy - 0.1f && yy + 0.1f >= gun_y)
                {
                    ...
                    if (num != count)
                    {
                        ...
                        PlaySound(TEXT("knife_draw.wav"), NULL, SND_FILENAME | SND_SYNC);
                        fruit_count++;
                        num = count;
                    }
        ...
        {
            glm::mat4 modelForSphere = glm::mat4(1.0f);
            translateMatrix = glm::translate(model, glm::vec3(-0.9f-xx, 2.0f, -1.2f));
            rotateZMatrix = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ...
        if (score>0 && fruit)
        {
            ...
            orangeIn.drawSphereWithTexture(lightingShaderWithTexture, modelForSphere2);
            ...
            translateMatrix = glm::translate(model, glm::vec3(randomValue + extra+.3f, 2.5f - fruit_y, -1.2f));
            rotateYMatrix = glm::rotate(identityMatrix, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
            rotateXMatrix = glm::rotate(identityMatrix, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
            modelForSphere1 = modelForSphere1 * translateMatrix * rotateXMatrix * rotateYMatrix;
            orangeOut.drawSphereWithTexture(lightingShaderWithTexture, modelForSphere1);
            waterIn.drawSphereWithTexture(lightingShaderWithTexture, modelForSphere1);

            glm::mat4 modelForSphere21 = glm::mat4(1.0f);
            translateMatrix = glm::translate(model, glm::vec3(randomValue - extra + .3f, 2.5f - fruit_y, -1.2f));
            rotateYMatrix = glm::rotate(identityMatrix, glm::radians(-angle), glm::vec3(0.0f, 1.0f, 0.0f));
            rotateXMatrix = glm::rotate(identityMatrix, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
            modelForSphere21 = modelForSphere21 * translateMatrix * rotateXMatrix * rotateYMatrix;
            orangeOut.drawSphereWithTexture(lightingShaderWithTexture, modelForSphere21);
            orangeIn.drawSphereWithTexture(lightingShaderWithTexture, modelForSphere21);*/
        }
     ...
     //  for (int i = 0; i < 25; i += 5) {
        modelPyr = transforamtion(-0.5, -0.6, -13, 1, 1, 1);
        modelPyr = modelPyr * model;
        tree(pyramid, lightingShaderWithTexture, modelPyr);
        modelPyr = transforamtion(-0.5 * 5, -4.0, -65, 3, 5, 3);
        modelPyr = model * modelPyr;
        cylinder2.Draw(lightingShaderWithTexture, modelPyr);
        // }

        modelPyr = transforamtion(3.5, -0.6, -13, 1, 1, 1);
        modelPyr = modelPyr * model;
        tree(pyramid, lightingShaderWithTexture, modelPyr);
        modelPyr = transforamtion(3.5 * 5, -4.0, -65, 3, 5, 3);
        modelPyr = model * modelPyr;
        cylinder2.Draw(lightingShaderWithTexture, modelPyr);


        modelPyr = transforamtion(3.5, -0.6, -9, 1, 1, 1);
        modelPyr = modelPyr * model;
        tree(pyramid, lightingShaderWithTexture, modelPyr);
        modelPyr = transforamtion(3.5 * 5, -4.0, -5 * 9, 3, 5, 3);
        modelPyr = model * modelPyr;
        cylinder2.Draw(lightingShaderWithTexture, modelPyr);

        modelPyr = transforamtion(-0.5, -0.6, -9, 1, 1, 1);
        modelPyr = modelPyr * model;
        tree(pyramid, lightingShaderWithTexture, modelPyr);
        modelPyr = transforamtion(-0.5 * 5, -4.0, -5 * 9, 3, 5, 3);
        modelPyr = model * modelPyr;
        cylinder2.Draw(lightingShaderWithTexture, modelPyr);
        ...
        rotateXMatrix = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.4, 0.3, 0.4));
        ...
        // wall with texture
        translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, 0.0f, 2.0f));
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(5.0f, 4.0f, 0.1f));
        ...
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.1f, 4.0f, 7.1f));
        glm::mat4 wallmodel2 = translateMatrix * scaleMatrix;;
        wallcube2.drawCubeWithTexture(lightingShaderWithTexture, wallmodel2);

        translateMatrix = glm::translate(identityMatrix, glm::vec3(2.5f, 0.0f, -5.0f));
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.1f, 4.0f, 7.1f));
        glm::mat4 wallmodel3 = translateMatrix * scaleMatrix;;
        wallcube2.drawCubeWithTexture(lightingShaderWithTexture, wallmodel3);
        ...
        if (score == 0)
        {
            ...
            //game over
            translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, 0.0f, 1.9f));
            scaleMatrix = glm::scale(identityMatrix, glm::vec3(5.0f, 4.0f, 0.1f));
            glm::mat4 modelMatrixForContainer3 = translateMatrix * scaleMatrix;
